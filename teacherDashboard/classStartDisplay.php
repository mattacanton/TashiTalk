<?php
	...
	// Apr 26 2016
	//
	// classStartDisplay.php
	// appends new class to database and displays information from classStart.php
	// expected input: user input to make new class from classStart
	// possible output: repeats entered information back to user	//======================================================================
	...
	if ($class_id === null || $class_id === false ||
		...
		<body>
			...
			<br><br><br>
			<!--reapeat entered information back to user-->

<?php
	...
	// Apr 26 2016
	//
	// contactLoggedOut/index.php
	// this index in contactLoggedOut sends a message to an email in the form of a contact form
	// expected input: user input to send a contact email
	// possible output: an email containing user input	//======================================================================
	...
	//page sends email to 'personalbizemail@gmail.com'
